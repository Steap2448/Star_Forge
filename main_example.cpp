...
int main()
{
	...
	Atlas atl;
	Celestial_Body Sun(0,0,0,0,0,0,5,1.9885e30), Earth(152.1e9,0,0,29.783e3,0,0,3,5.9726e24), Moon(x_satellite(0.4055e9, &Earth), y_satellite(0, &Earth), v_x_satellite(0, &Earth), v_y_satellite(1350, &Earth), 0, 0, 1, 73.46e21), Mars(206.62e9 , 0, 0, 26.50e3, 0, 0, 3, 0.64171e24);
